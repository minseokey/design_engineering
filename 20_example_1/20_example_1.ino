...
//    return (954 + (-5.08 * a_value) + 0.00963 * pow(a_value,2)+ (-0.00000631 * pow(a_value,3)));
...
void loop()
{
  ...
  int dist_filtered = volt_to_distance(ir_sensor_filtered(100,0.5));
  Serial.print("disFLT:"); Serial.println(dist_filtered);
  }
}
